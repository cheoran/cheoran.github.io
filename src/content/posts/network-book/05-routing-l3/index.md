...
## 05.14 출판 심화: Longest Prefix Match 예시
...
### 라우팅 테이블이란
- "어떤 네트워크는 어디로 보내라"는 **길 안내 표**다.
- 기본 게이트웨이는 "모르면 이쪽으로 보내라"는 의미다.
